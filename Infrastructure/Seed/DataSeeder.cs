    ...
    public class DataSeeder
    {
        ...
        public async Task SeedBranchType()
        {
            if(!await _context.BranchTypes.AnyAsync())
            {
                ...
                {
                    new BranchType(Guid.NewGuid(),"प्रधान कार्यालय","Head Office"),
                    new BranchType(Guid.NewGuid(),"वडा कार्यालय","ward office"),
                    new BranchType(Guid.NewGuid(), "विभाग कार्यालय", "Department Office")
                };
