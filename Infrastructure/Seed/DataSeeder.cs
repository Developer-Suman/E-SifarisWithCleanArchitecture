...
namespace Infrastructure.Seed
{
    public class DataSeeder
    {
        ...
        private async Task SeedRole()
        {
            if (!await _roleManager.Roles.AnyAsync())
            {
                ...
                var roles = new List<IdentityRole>()
                {
                    ...
                    new IdentityRole(){Name = Role.WardAdmin},
                    new IdentityRole(){Name = Role.WardUser},
                    new IdentityRole(){Name = Role.DepartmentAdmin},
                    new IdentityRole(){Name =Role.DepartmentUser},
                    new IdentityRole(){Name = Role.PalikaAdmin},
                    new IdentityRole(){Name = Role.PalikaUser},
        ...
        #region BranchType
        public async Task SeedBranchType()
        {
            if (!await _context.BranchTypes.AnyAsync())
            {
                var branchTypes = new List<BranchType>()
                {
                    new BranchType(1,"प्रधान कार्यालय","Head Office"),
                    new BranchType(2,"वडा कार्यालय","ward office"),
                    new BranchType(3, "विभाग कार्यालय", "Department Office")
                };

                await _context.BranchTypes.AddRangeAsync(branchTypes);
        ...
        #region Proviance
        public async Task SeedProviance()
        {
            if (!await _context.Proviances.AnyAsync())
            {
                var proviances = new List<Proviance>()
                {
                    new Proviance(1,"कोशी प्रदेश","Koshi Province"),
                new Proviance(2,"मधेश प्रदेश","Madhesh Province"),
                new Proviance(3,"बाग्मती प्रदेश","Bagmati Province"),
                new Proviance(4,"गण्डकी प्रदेश","Gandaki Province"),
                new Proviance(5,"लुम्बिनी प्रदेश","Lumbini Province"),
                new Proviance(6,"कर्णाली प्रदेश","Karnali Province"),
                new Proviance(7,"सुदूरपश्चिम प्रदेश","Sudurpashchim Province"),
                };

                await _context.Proviances.AddRangeAsync(proviances);
                await _unitOfWork.SaveChangesAsync();
            }
        }
        #endregion
        ...
        #region District
        public async Task SeedDistrict()
        {
        ...
        public async Task SeedMunicipality()
        {
            if (!await _context.municipalities.AnyAsync())
            {
                ...
                await _context.municipalities.AddRangeAsync(municipality);
                await _unitOfWork.SaveChangesAsync();
            }
        }
        #endregion
        ...
        public async Task SeedVdc()
        {
            if (!await _context.Vdcs.AnyAsync())
            {
                ...
                await _context.Vdcs.AddRangeAsync(vdc);
                await _unitOfWork.SaveChangesAsync();
            }
        }
        #endregion
        ...
        private async Task SeedDepartment()
        {
            if (!await _context.Departments.AnyAsync())
            {
                var departments = new List<Department>()
                {
                    ...
                    new Department(3,"महिला तथा बालबालिका शाखा","Women and Child Welfare Center"),
                    new Department(4,"आर्थिक प्रशासन","Economic Administration"),
                    new Department(5, "जिन्सी शाखा ", "Jinsi Department"),
                  new Department(6, "प्रशासन व्यवस्थापन शाखा ", "Administration Management Department"),
                  new Department(7, "सूचना प्रविधि शाखा ", "Information Technology Department"),
                  new Department(8, "श्रम तथा रोजगार शाखा ", "Labor and Employment Department"),
                  new Department(9, "दर्ता चलानी शाखा ", "Registration Invoice Department"),
                  new Department(10, "योजना शाखा ", "Planning Branch"),
                  new Department(11, "घर नक्शा शाखा ", null),
                  new Department(12, "विधुत शाखा ", "Electricity Department"),
                  new Department(13, "पञ्जिकरण शाखा ", null),
                  new Department(14, "सामाजिक शाखा", "Social Department"),
                  new Department(15, "पशु सेवा शाखा", "Animal Service Department"),
                  new Department(17, "लेखा शाखा", "Accounts Department"),
                  new Department(1015, "व्यवसाय/सहकारी शाखा", "Business/Cooperative Department"),
                  new Department(1016, "प्राविधिक शाखा", "Technical Department"),
                  new Department(1017, "उद्योग शाखा", "Industry Department"),
                };
